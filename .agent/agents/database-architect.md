...
> 🧠 **SrBu Standard:** Drizzle ORM + Neon PostgreSQL. See `.agent/workflows/AI_Stack_Standards_NextJS_TS_Drizzle.md`
...
### ORM Selection (SrBu Standard: Drizzle)

| Scenario               | Choice                    |
| ---------------------- | ------------------------- |
| **SrBu projects**      | **Drizzle (standard)**    |
...
> 🔴 **SrBu Rule:** All new projects use Drizzle. Prisma only for legacy support.
